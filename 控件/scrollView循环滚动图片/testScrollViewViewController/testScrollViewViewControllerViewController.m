...
@interface testScrollViewViewControllerViewController ()
{
    ...
    UIView *labelScrollViewBackground;
}
...
- (void)initLabelScrollView
{
    ...
    labelScrollViewBackground = [[UIView alloc] initWithFrame:CGRectMake(0, 320,CGRectGetWidth(self.view.bounds), 95)];
    [labelScrollViewBackground setBackgroundColor:[UIColor clearColor]];
    //[labelScrollViewBackground setBackgroundColor:[UIColor colorWithWhite:1.0 alpha:0.85]];
    
    [self.view addSubview:labelScrollViewBackground];
    
    labelScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.view.bounds), 95)];
    [labelScrollView setBackgroundColor:[UIColor colorWithWhite:1.0 alpha:0.85]];
    [labelScrollViewBackground addSubview:labelScrollView];
...
//创建在scrollView上面显示的view(最多只显示10个)
- (void)createAllEmptyPagesForScrollView: (int) pages {
    ...
    if(pages <= 10){
        ...
        for (int pageTemp = 0; pageTemp < 12; pageTemp++) {
            CGRect frame = labelScrollView.frame;
            UIView *viewTemp1 = [[UIView alloc] initWithFrame:CGRectMake(frame.size.width * pageTemp, 0 , frame.size.width, frame.size.height)];
            [labelScrollView addSubview:viewTemp1];
